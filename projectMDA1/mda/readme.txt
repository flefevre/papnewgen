    ...
    The project located in this directory has been generated by Francois
    ...
    that a model called 'papnewgen' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /papnewgen J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Francois/.m2/repository/papnewgen/
